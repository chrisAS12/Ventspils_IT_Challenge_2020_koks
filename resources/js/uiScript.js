...
var treesPerSquareMeterValue = document.getElementById(
  "treesPerSquareMeterValue"
);
...
treesPerSquareMeterSlider.oninput = function () {
  ...
  treesPerSquareMeterValue.innerHTML =
    "VALUE: " + treesPerSquareMeter + " (N/M^2)";
};

var fixedSliderArray = [
  birchPercentageSlider,
  pineTreePrecentageSlider,
  sprucePercentageSlider,
  radiusSlider,
  treesPerSquareMeterSlider,
];
...
function changeSliderPercentageValue() {
  ...
  percentageValue.innerHTML =
    "SPRUCE: " +
    percentageRounding(percentages[2]) +
    "%" +
    "<br>" +
    "PINE: " +
    percentageRounding(percentages[0]) +
    "%" +
    "<br>" +
    "BIRCH: " +
    percentageRounding(percentages[1]) +
    "%" +
    "<br>";
}
...
function getPercentages() {
  let maxPercentage =
    parseInt(pineTreePrecentage) +
    parseInt(birchPercentage) +
    parseInt(sprucePercentage);
  if (maxPercentage == 0) {
    maxPercentage = 1;
  }

  var percentages = [
    pineTreePrecentage / maxPercentage,
    birchPercentage / maxPercentage,
    sprucePercentage / maxPercentage,
  ];
